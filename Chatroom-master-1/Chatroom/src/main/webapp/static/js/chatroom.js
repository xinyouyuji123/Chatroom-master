    ...
    $(".myfile").fileinput({
        ...
        dropZoneTitle: "Please drag and drop the image file here",
        ...
        msgFilesTooMany : "Select the number of files to upload({n}) Exceeds maximum allowed value{m}！",
        language : 'zh'
    })
    //异步上传返回结果处理
	...
	$('.sendBtn').on('click',function(){
		...
		if (toUserId == '' && toGroupId == '') {
			alert("Please select the person to talk to");
			return;
		}
		if(news == ''){
